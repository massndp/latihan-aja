                ...
                <div class="card-body">
                  <form action="{{route('dashboard.store')}}" method="POST">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="pembayaran" class="form-control d-inline ml-3" id="pembayaran" style="width: 50%" value="{{old('pembayaran')}}">
                      </div>        
                      <div class="form-group">
                          <label for="buruh_a">Buruh A</label>
                          <input type="text" id="buruha" name="buruh_a" class="form-control d-inline ml-5" style="width: 30%" value="{{old('buruh_a')}}">  &nbsp; % 
                      </div>        
                      <div class="form-group">
                          <label for="buruh_b">Buruh B</label>
                          <input type="text" id="buruhb" name="buruh_b" class="form-control d-inline ml-5" style="width: 30%; align=left" value="{{old('buruh_b')}}"> &nbsp; % 
                      </div>        
                      <div class="form-group">
                          <label for="buruh_c">Buruh C</label>
                          <input type="text" id="buruhc" name="buruh_c" class="form-control d-inline ml-5" style="width: 30%" value="{{old('buruh_c')}}">  &nbsp; %    
                      </div>    
